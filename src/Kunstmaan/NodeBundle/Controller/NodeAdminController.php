...
class NodeAdminController extends Controller
{
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        $this->nodeHelper->deletePage($node, $this->locale);
    ...
    public function addAction(Request $request, $id)
    {
        ...
        $title = $request->get('title');
        $nodeTranslation = $this->nodeHelper->createPage($this->user, $type, $title, $this->locale, $parentNode);
        $nodeNewPage = $nodeTranslation->getNode();
    ...
    public function addHomepageAction(Request $request)
    {
        ...
        $nodeTranslation = $this->nodeHelper->createPage($this->user, $type, $title, $this->locale);
        $nodeNewPage = $nodeTranslation->getNode();
